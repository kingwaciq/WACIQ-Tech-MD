const mindReads = [
  ...
  "*Arslan-Tech-Bot-V2* detected some deep thoughts 👁️✨",
  ...
  "*🧘 Energy level rising... Arslan-Tech-Bot-V2 reading deeper...*",
...
module.exports = {
  name: "mindread",
  description: "🧠 Reads the replied user's mind using Arslan-Tech-Bot-V2's deep AI magic ✨",
  category: "fun",
